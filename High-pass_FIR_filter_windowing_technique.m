% To plot the frequency response of a high-pass FIR filter
...
hd=(sin((n-alpha+delta)*pi)-sin(wc*(n-alpha+delta)))./(n-alpha+delta); % Desired Filter Impulse Response-IIR Filter
