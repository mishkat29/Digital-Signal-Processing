% To plot the frequency response of a band-pass FIR filter
...
hd=(sin(wc2*(n-alpha+delta))-sin(wc1*(n-alpha+delta)))./(n-alpha+delta); % Desired Filter Impulse Response-IIR Filter
